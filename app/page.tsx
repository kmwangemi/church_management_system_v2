  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Streamline your church operations with our comprehensive management solution. Handle members, finances,
            events, assets, and spiritual growth all in one place.
          </p>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Everything Your Church Needs</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              From member management to financial tracking, our platform provides all the tools you need to grow and
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600">See what pastors and administrators are saying about ChurchFlow</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "ChurchFlow has transformed how we manage our congregation. The member management and financial
                  tracking features are exactly what we needed."
                </CardDescription>
                <div className="mt-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "The asset management feature helps us keep track of all our church properties and vehicles. The
                  maintenance scheduling is a game-changer."
                </CardDescription>
                <div className="mt-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  "The discipleship tracking and communication features have helped us better connect with our members
                  and track their spiritual growth."
                </CardDescription>
                <div className="mt-4">
      ...
      <section className="py-20 px-4 bg-blue-600 text-white">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Transform Your Church Management?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of churches already using ChurchFlow to streamline operations and focus on what matters most
            - ministry.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Empowering churches with comprehensive management solutions for growth and ministry excellence.
              </p>
            </div>
            <div>
