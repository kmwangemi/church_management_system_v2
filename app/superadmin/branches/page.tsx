...
export default function BranchesPage() {
  ...
  const filteredBranches = branches.filter((branch) => {
    ...
    const matchesChurch = churchFilter === "all" || branch.churchId.toString() === churchFilter
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage all church branches and their locations</p>
        </div>
        <Button>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {branches.reduce((sum, branch) => sum + branch.members, 0).toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {branches.reduce((sum, branch) => sum + branch.capacity, 0).toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">Across all branch locations</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete list of all church branches with location and performance data</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <TableRow key={branch.id}>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Branch Pastor</div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-start space-x-2">
                        <Map className="mt-0.5 h-4 w-4 text-muted-foreground flex-shrink-0" />
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        ...
                        <div className={`text-xs ${getCapacityColor(branch.members, branch.capacity)}`}>
                          {Math.round((branch.members / branch.capacity) * 100)}% occupied
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
