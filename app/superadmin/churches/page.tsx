    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage all registered churches and their information</p>
        </div>
        <Dialog>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{churches.reduce((sum, church) => sum + church.branches, 0)}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${churches.reduce((sum, church) => sum + church.revenue, 0).toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Complete list of all registered churches with detailed information</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <TableRow key={church.id}>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">Lead Pastor</div>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        <DollarSign className="mr-1 h-4 w-4 text-muted-foreground" />${church.revenue.toLocaleString()}
                      </div>
                    </TableCell>
                    <TableCell>
