...
export default function SystemHealthPage() {
  ...
  const services = [
    { name: "Web Server", status: "online", uptime: "99.98%", lastCheck: "1 min ago" },
    { name: "Database Server", status: "online", uptime: "99.95%", lastCheck: "1 min ago" },
    { name: "Email Service", status: "online", uptime: "99.92%", lastCheck: "2 min ago" },
    { name: "File Storage", status: "online", uptime: "99.99%", lastCheck: "1 min ago" },
    { name: "Backup Service", status: "maintenance", uptime: "99.85%", lastCheck: "5 min ago" },
    ...
    <div className="space-y-6">
          ...
          >
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={performanceData}>
                ...
                <Legend />
                <Line type="monotone" dataKey="cpu" stroke="var(--color-cpu)" strokeWidth={2} name="CPU Usage" />
                <Line
                  type="monotone"
                  dataKey="memory"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Quick actions for system maintenance and management</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
