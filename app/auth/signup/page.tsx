      ...
      <div className="w-full max-w-2xl">
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-gray-600">Set up your church management system in minutes</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="mega">Mega (1000+ members)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormMessage />
                        </FormItem>
