...
// ============================================
// ADD MEMBER TO ORGANIZATION (COMPREHENSIVE)
// ============================================
...
export async function addMemberToOrganization(
  ...
  try {
    ...
    const result = await createNewMemberWithDetails(params, session.user.id);
    if (!result.success) {
...
// ============================================
// HELPER: ADD EXISTING USER TO ORGANIZATION
// ============================================
...
// ============================================
// HELPER: CREATE NEW MEMBER WITH DETAILS
// ============================================

async function createNewMemberWithDetails(
  params: AddMemberParams,
  createdBy: string
): Promise<ServerActionResponse> {
  try {
...
// ============================================
// HELPER: CREATE ROLE-SPECIFIC DETAILS
// ============================================
...
export async function updateMemberDetails(
  ...
  try {
    ...
    revalidatePath(`/superadmin/churches/${params.organizationId}/members`);
    return {
      success: true,
      data: result,
...
// ============================================
// HELPER: UPDATE ROLE-SPECIFIC DETAILS
// ============================================

async function updateRoleSpecificDetails(
  tx: any,
  userId: string,
  params: UpdateMemberParams
): Promise<void> {
...
export async function getMemberByUserId(
  userId: string,
  organizationId?: string
): Promise<ServerActionResponse<MemberFullDetails>> {
  try {
    // Step 1: Verify session
    const session = await getServerSession();
    if (!session?.user) {
    ...
    const memberFullDetails: MemberFullDetails = {
      user,
      address,
      emergencyContact,
      memberDetails,
...
export async function getMemberStatistics(
  organizationId: string
): Promise<ServerActionResponse<MemberStatistics>> {
  try {
    // Verify session
    const session = await getServerSession();
    if (!session?.user) {
