      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Submit a prayer request for the church community</CardDescription>
          </CardHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Please provide details about your prayer request..." rows={4} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <p className="text-sm text-gray-500">Your name will not be shown with this request</p>
                    </div>
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <p className="text-sm text-gray-500">Allow all church members to see and pray for this request</p>
                    </div>
                  </FormItem>
                )}
              />
